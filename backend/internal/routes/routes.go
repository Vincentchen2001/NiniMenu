...
func Setup(r *gin.Engine) {
	...
	api := r.Group("/api")
	{
		...
		app.Use(middleware.AppAuthMiddleware())
		{
			...
			app.PUT("/week-plan", handlers.SaveWeekPlanHandler)
			app.GET("/week-plan/preferences", handlers.GetWeekPlanPreferencesHandler)
			app.PUT("/week-plan/preferences", handlers.UpdateWeekPlanPreferencesHandler)
	...
	admin.Use(middleware.AuthMiddleware())
	{
		...
		admin.PUT("/week-plan/rules", handlers.UpdateWeekPlanRulesHandler)
		admin.POST("/week-plan/rules/validate", handlers.ValidateWeekPlanRuleHandler)
